...
## Care with your data{visibility="hidden"}
...
## Preprocessing correctly{visibility="hidden"}
...
## Anatomy of a forecaster{visibility="hidden"}
...
### Exploratory Data Analysis (EDA) type stuff
...
# Build a forecaster from scratch{visibility="hidden"}
...
## What if we want more direct control on each single step?{visibility="hidden"}

:::

## Under the hood of `arx_forecaster()`{visibility="hidden"}
...
## Predicting influenza hospitalizations{visibility="hidden"}
...
## Aside: data issues{visibility="hidden"}
...
## We don't know if we trust the data yet enough{visibility="hidden"}
...
## Climatological forecaster{visibility="hidden"}
...
## Climate predictions for this week{visibility="hidden"}
