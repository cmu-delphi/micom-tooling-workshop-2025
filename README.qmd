...
### Steps:
1. On the [MICOM Tooling Workshop 2025 GitHub repository](https://github.com/cmu-delphi/micom-tooling-workshop-2025).
...
You can now open the `micom-tooling-workshop-2025.Rproj` file and start working
with them.
...
1. Run `git clone https://github.com/cmu-delphi/micom-tooling-workshop-2025.git`
1. Once cloning is complete, navigate into the project folder: `cd micom-tooling-workshop-2025`
